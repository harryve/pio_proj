...
*OUTPUT       :none
****************************************************************/
void HARRY_CC1101::SpiStart(void)
{
...
*OUTPUT       : none
****************************************************************/
// void HARRY_CC1101::GDO_Set (void)
// {
//     pinMode(GDO0, OUTPUT);
//     pinMode(GDO2, INPUT);
// }
...
*OUTPUT       : none
****************************************************************/
//void HARRY_CC1101::GDO0_Set (void)
//{
//    pinMode(GDO0, INPUT);
//}
/****************************************************************
...
*OUTPUT       :none
****************************************************************/
void HARRY_CC1101::SpiWriteReg(byte addr, byte value)
{
    SpiStart();
    digitalWrite(SS_PIN, LOW);
    while(digitalRead(MISO_PIN));
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::SpiWriteBurstReg(byte addr, byte *buffer, byte num)
// {
//   byte i, temp;
//   SpiStart();
...
*OUTPUT       :none
****************************************************************/
void HARRY_CC1101::SpiStrobe(byte strobe)
{
    SpiStart();
    digitalWrite(SS_PIN, LOW);
    while(digitalRead(MISO_PIN));
...
****************************************************************/
byte HARRY_CC1101::SpiReadReg(byte addr)
{
    byte temp, value;
    SpiStart();
...
*OUTPUT       :none
****************************************************************/
void HARRY_CC1101::SpiReadBurstReg(byte addr, byte *buffer, byte num)
{
    byte i,temp;
    SpiStart();
...
*OUTPUT       :status value
****************************************************************/
byte HARRY_CC1101::SpiReadStatus(byte addr)
{
    byte value,temp;
    SpiStart();
    temp = addr | READ_BURST;
...
*OUTPUT       :none
****************************************************************/
void HARRY_CC1101::setSpiPin(byte sck, byte miso, byte mosi, byte ss){
    spi = 1;
    SCK_PIN = sck;
    MISO_PIN = miso;
    MOSI_PIN = mosi;
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::addSpiPin(byte sck, byte miso, byte mosi, byte ss, byte modul){
//     spi = 1;
//     SCK_PIN_M[modul] = sck;
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::setGDO(byte gdo0, byte gdo2){
// GDO0 = gdo0;
// GDO2 = gdo2;
// GDO_Set();
// }
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::setGDO0(byte gdo0){
// //GDO0 = gdo0;
// GDO0_Set();
// }
/****************************************************************
...
*OUTPUT       :none
****************************************************************/
//void HARRY_CC1101::addGDO(byte gdo0, byte gdo2, byte modul){
//GDO0_M[modul] = gdo0;
//GDO2_M[modul] = gdo2;
//gdo_set=2;
//GDO_Set();
...
*OUTPUT       :none
****************************************************************/
//void HARRY_CC1101::addGDO0(byte gdo0, byte modul){
//GDO0_M[modul] = gdo0;
//gdo_set=1;
//GDO0_Set();
//}
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::setModul(byte modul)
// {
...
*OUTPUT       :none
****************************************************************/
void HARRY_CC1101::setCCMode(bool s)
{
    ccmode = s;
...
*OUTPUT       :none
****************************************************************/
void HARRY_CC1101::setModulation(byte m)
{
    if (m>4) {
        m=4;
    }
...
*OUTPUT       :none
****************************************************************/
void HARRY_CC1101::setMHZ(float mhz)
{
    byte freq2 = 0;
    byte freq1 = 0;
    byte freq0 = 0;
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::Calibrate(void)
// {
...
//       int s = HARRY_cc1101.SpiReadStatus(CC1101_FSCAL2);
//       if (s<32) {
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::setClb(byte b, byte s, byte e){
// if (b == 1){
// clb1[0]=s;
// clb1[1]=e;
// }
...
*OUTPUT       :none
****************************************************************/
bool HARRY_CC1101::getCC1101(void)
{
    setSpi();
...
*OUTPUT       :none
****************************************************************/
// byte HARRY_CC1101::getMode(void){
// return trxstate;
// }
/****************************************************************
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::setSyncWord(byte sh, byte sl){
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::setAddr(byte v){
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::setPQT(byte v){
// Split_PKTCTRL1();
// pc1PQT = 0;
// if (v>7){v=7;}
// pc1PQT = v*32;
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::setCRC_AF(bool v){
// Split_PKTCTRL1();
// pc1CRC_AF = 0;
// if (v==1){pc1CRC_AF=8;}
// SpiWriteReg(CC1101_PKTCTRL1, pc1PQT+pc1CRC_AF+pc1APP_ST+pc1ADRCHK);
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::setAppendStatus(bool v){
// Split_PKTCTRL1();
// pc1APP_ST = 0;
// if (v==1){pc1APP_ST=4;}
// SpiWriteReg(CC1101_PKTCTRL1, pc1PQT+pc1CRC_AF+pc1APP_ST+pc1ADRCHK);
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::setAdrChk(byte v){
// Split_PKTCTRL1();
// pc1ADRCHK = 0;
// if (v>3){v=3;}
// pc1ADRCHK = v;
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::setWhiteData(bool v){
// Split_PKTCTRL0();
// pc0WDATA = 0;
// if (v == 1){pc0WDATA=64;}
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::setPktFormat(byte v){
// Split_PKTCTRL0();
// pc0PktForm = 0;
// if (v>3){v=3;}
// pc0PktForm = v*16;
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::setCrc(bool v){
// Split_PKTCTRL0();
// pc0CRC_EN = 0;
// if (v==1){pc0CRC_EN=4;}
// SpiWriteReg(CC1101_PKTCTRL0, pc0WDATA+pc0PktForm+pc0CRC_EN+pc0LenConf);
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::setLengthConfig(byte v){
// Split_PKTCTRL0();
// pc0LenConf = 0;
// if (v>3){v=3;}
// pc0LenConf = v;
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::setPacketLength(byte v){
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::setDcFilterOff(bool v){
// Split_MDMCFG2();
// m2DCOFF = 0;
// if (v==1){m2DCOFF=128;}
// SpiWriteReg(CC1101_MDMCFG2, m2DCOFF+m2MODFM+m2MANCH+m2SYNCM);
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::setManchester(bool v){
// Split_MDMCFG2();
// m2MANCH = 0;
// if (v==1){m2MANCH=8;}
// SpiWriteReg(CC1101_MDMCFG2, m2DCOFF+m2MODFM+m2MANCH+m2SYNCM);
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::setSyncMode(byte v){
// Split_MDMCFG2();
// m2SYNCM = 0;
// if (v>7){v=7;}
// m2SYNCM=v;
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::setFEC(bool v){
// Split_MDMCFG1();
// m1FEC=0;
// if (v==1){m1FEC=128;}
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::setPRE(byte v){
// Split_MDMCFG1();
// m1PRE=0;
// if (v>7){v=7;}
// m1PRE = v*16;
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::setChannel(byte ch){
// chan = ch;
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::setChsp(float f){
// Split_MDMCFG1();
// byte MDMCFG0 = 0;
// m1CHSP = 0;
...
*OUTPUT       :none
****************************************************************/
void HARRY_CC1101::setRxBW(float f)
{
    Split_MDMCFG4();
    int s1 = 3;
    int s2 = 3;
...
*OUTPUT       :none
****************************************************************/
void HARRY_CC1101::setDRate(float d)
{
    Split_MDMCFG4();
    float c = d;
    byte MDMCFG3 = 0;
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::setDeviation(float d){
// float f = 1.586914;
// float v = 0.19836425;
// int c = 0;
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::Split_PKTCTRL1(void){
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::Split_PKTCTRL0(void){
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::Split_MDMCFG1(void){
...
*OUTPUT       :none
****************************************************************/
void HARRY_CC1101::Split_MDMCFG2(void){
...
*OUTPUT       :none
****************************************************************/
void HARRY_CC1101::Split_MDMCFG4(void)
{
...
*OUTPUT       :none
****************************************************************/
void HARRY_CC1101::RegConfigSettings(void)
{
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::SetTx(float mhz)
// {
//   SpiStrobe(CC1101_SIDLE);
//   setMHZ(mhz);
//   SpiStrobe(CC1101_STX);        //start send
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::SetRx(float mhz)
// {
//   SpiStrobe(CC1101_SIDLE);
//   setMHZ(mhz);
//   SpiStrobe(CC1101_SRX);        //start receive
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::setSres(void)
// {
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::setSidle(void)
// {
//   SpiStrobe(CC1101_SIDLE);
//   trxstate=0;
// }
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::goSleep(void){
//   trxstate=0;
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::SendData(char *txchar)
// {
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::SendData(byte *txBuffer,byte size)
// {
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::SendData(char *txchar,int t)
// {
// int len = strlen(txchar);
// byte chartobyte[len];
// for (int i = 0; i<len; i++){chartobyte[i] = txchar[i];}
...
*OUTPUT       :none
****************************************************************/
// void HARRY_CC1101::SendData(byte *txBuffer,byte size,int t)
// {
//   SpiWriteReg(CC1101_TXFIFO,size);
//   SpiWriteBurstReg(CC1101_TXFIFO,txBuffer,size);      //write data to send
//   SpiStrobe(CC1101_SIDLE);
...
*OUTPUT       :none
****************************************************************/
// bool HARRY_CC1101::CheckCRC(void){
...
****************************************************************/
// bool HARRY_CC1101::CheckRxFifo(int t){
// if(trxstate!=2){SetRx();}
...
*OUTPUT       :flag: 0 no data; 1 receive data
****************************************************************/
// byte HARRY_CC1101::CheckReceiveFlag(void)
// {
//   if(trxstate!=2){SetRx();}
...
****************************************************************/
// byte HARRY_CC1101::ReceiveData(byte *rxBuffer)
// {
// 	byte size;
// 	byte status[2];
